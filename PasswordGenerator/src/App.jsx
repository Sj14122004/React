  ...
  return (
    <>
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-4 my-8  bg-gray-800 ">
        ...
        <div className="flex shadow rounded-lg overflow-hidden mb-4 my-3 bg-gray-300">
          <input 
          ref = {passRef}
          type="text" value = {password} className="outline-none w-full py-1 px-3 bg-white text-orange-500"
          placeholder="Password" 
          readOnly/>
          <button
          onClick = {copyPass}
          className="outline-none bg-blue-500 text-white px-3 py-0.5 shrink-0 hover:scale-101 hover:bg-red-500">Copy</button>
        </div>
        <div className="flex text-sm  gap-x-2">
          ...
          <div className="flex items-center gap-x-1 text-orange-500 mx-1">
            <input type="checkbox"
